...
public final class Wendy: Sendable, Singleton {
    ...
    ///   - semaphoreValue: The maximum number of concurrent tasks allowed. Defaults to nil (uses current WendyConfig.semaphoreValue).
    public class func setup(taskRunner: WendyTaskRunner, debug: Bool = false, semaphoreValue: Int = 1) {
